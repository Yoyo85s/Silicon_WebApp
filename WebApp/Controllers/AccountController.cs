    ...
    public async Task<IActionResult> UpdateAddressInfo(AccountDetailsViewModel model)
    {
        if (TryValidateModel(model.Address!))
        {
            ...
            try
            {
                ...
                {
                    user.Address.AddressLine1 = model.Address!.AddressLine_1;
                    user.Address.AddressLine2 = model.Address!.AddressLine_2;
                ...
                else
                {
                    ...
                    {
                        AddressLine1 = model.Address!.AddressLine_1,
                        AddressLine2 = model.Address!.AddressLine_2,
